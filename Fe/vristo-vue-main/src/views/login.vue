            ...
            <div
                ...
                <div
                    ...
                    <div class="mx-auto w-full max-w-[440px]">
                        <div class="mb-10">
                            <h1 class="text-3xl font-extrabold uppercase !leading-snug text-primary md:text-4xl">Đăng nhập
                            </h1>
                            <p class="text-base font-bold leading-normal text-white-dark">Nhập tên đăng nhập/SĐT và mật khẩu
                                để tiếp tục</p>
                        </div>
